...
func (t *tserver) GetSubscribersForSubscription(ctx context.Context, req *api.ID) (*api.GetSubscribersResponse, error) {

	subscriptions, err := t.repo.GetSubscribersForSubscription(ctx, int(req.Id))
